...
public class FalhaDeComunicacaoException extends RuntimeException {
    ...
    public <T> FalhaDeComunicacaoException(Class<T> recurso, int status, Object... params) {
        super("Erro na chamada " + recurso.getSimpleName() + " para os parametros " + Arrays.toString(params));
